function output = readFromNav_Odom_pos(obj,father)
    try
        ...
        theta=[];
        for i=1:length(msg)      
            obj.x(i)=-msg{i}.Pose.Pose.Position.X;
            obj.y(i)=msg{i}.Pose.Pose.Position.Y;
            obj.z(i)=msg{i}.Pose.Pose.Position.Z;
            obj.th(i)=-2*atan2(msg{i}.Pose.Pose.Orientation.Z,msg{i}.Pose.Pose.Orientation.W);
        end
        str.x=obj.x;
        str.y=obj.y;
        str.z=obj.y;
